...
export function Home() {
    ...
    const stats = [
        { value: '2', label: 'min. 🍺 / Tag' },
        { value: '100%', label: 'Bierliebhaber' },
        { value: '3', label: 'Events / Jahr' },
        { value: '24/7', label: 'Immer 🍺' },
    ];
            ...
            <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
                <div className="text-center max-w-4xl mx-auto mb-16">
                    <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                        Willkomen bei schoensaufen.at
                    </h1>
                    <p className="text-lg md:text-xl opacity-80 mb-8">
                        Derzeit wissen wir noch nicht was wir für einen Content hier anbieten sollen. Aber bei ein oder zwei oder 15 Bier wird uns schon was einfallen.
                    </p>
